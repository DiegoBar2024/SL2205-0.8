...
import scipy.signal
import sys
sys.path.append('C:/Yo/Tesis/SL2205-0.8/SL2205-0.8/KielMAT-main/kielmat/utils')
...
class PhamPosturalTransitionDetection:
    ...
    def detect(
        ...
        if range_x > range_z or var_x > var_z:
            ...
            self.gyro_mediolateral = self.gyro[:, 2]  # Gyro z-axis is mediolateral
