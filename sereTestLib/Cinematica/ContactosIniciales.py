...
def ContactosIniciales(acel, cant_muestras, periodoMuestreo, graficar = False):
    ...
    ## En caso de que quiera graficar los contactos iniciales detectados
    if graficar:

        ## Se hace la graficación de la señal marcando los picos
        GraficacionPicos(acc_AP_norm, picos_sucesivos)
    
    ## Retorno los picos de la anteroposterior como estimaciones de los contactos iniciales de la marcha y la cantidad de muestras del paso
    return picos_sucesivos, muestras_paso, acc_AP_norm, frec_fund