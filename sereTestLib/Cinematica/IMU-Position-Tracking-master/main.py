...
class IMUTracker:
    ...
    def initialize(self, data, noise_coefficient={'w': 100, 'a': 100, 'm': 10}):
        ...
        ## <<data>> va a tener que ser un ndarray (N, 9) donde las filas son las muestras y tengo 9 columnas
        ## Las columnas tienen que ir en éste orden (omega_x, omega_y, omega_z, acc_x, acc_y, acc_z, mag_x, mag_y, mag_z)
