...
for id_persona in ids_existentes:
    ...
    try:
        ...
        segmentos = sorted(os.listdir('C:/Yo/Tesis/sereData/sereData/Dataset/escalogramas_giros_tot/S{}'.format(id_persona)), key = len)
        ...
        for j in range (len(segmentos)):
            ...
            escalograma_segmento = np.load(ruta_escalogramas + '/S{}/{}'.format(id_persona, segmentos[j]))['X']
