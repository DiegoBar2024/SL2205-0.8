...
## ----------------------------- COMPRESIÓN DE MARCHA SIN GIROS CON AUTOENCODER ----------------------------------------
    ...
    for id_persona in ids_existentes:
        ...
        try:
            ...
            for i in range (len(tramos)):
                ...
                ## Especifico la ruta donde se guardan las comprimidas
...
if __name__== '__main__':
    ...
    ## Hago el guardado de las features con el autoencoder
    CompresionAutoencoder()